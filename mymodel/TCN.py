...
class TCN(nn.Module):
    def __init__(self, input_size, output_size, num_channels, kernel_size=2, dropout=0.2, emb_dropout=0.2):
        ...
        self.encoder = Informer(7,7, input_size,out_len =128,
                                seq_len= 512, 
                                label_len = 512,
                                d_model=128,
                                dropout= 0.2)
        ...
        self.decoder2 = nn.Linear(input_size, 1)
    ...
    def forward(self, x):
        ...
        o1 = self.decoder(y.transpose(1, 2))
        o2 = self.decoder2(y.transpose(1, 2))
        return o1[:,-1,:],o2[:,-1,:]



if __name__=="__main__":
    model=TCN(100,3,[128]*3+[100])
    data =torch.rand((32,1024,7))
    out= model(data)
    pass